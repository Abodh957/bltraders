        ...
        <div class="container">
            <div class="header-left col-lg-2 w-auto pl-0">
                ...
                <a href="demo4.html" class="logo">
                    <img src="{{ config('custom.public_path') . '/frontAssets/assets/images/logo.png'}}" width="111" height="44" alt="Porto Logo">
                </a>
            </div>
            <!-- End .header-left -->
            ...
            <div class="header-right w-lg-max">
                ...
                <div class="header-contact d-none d-lg-flex pl-4 pr-4">
                    <img alt="phone" src="{{ config('custom.public_path') . '/frontAssets/assets/images/phone.png'}}" width="30" height="30" class="pb-1">
                        ...
                        <div class="dropdownmenu-wrapper custom-scrollbar">
                            ...
                            <div class="dropdown-cart-products">
                                <div class="product">
                                    ...
                                    <figure class="product-image-container">
                                        <a href="product.html" class="product-image">
                                            <img src="{{ config('custom.public_path') . '/frontAssets/assets/images/products/product-1.jpg'}}" alt="product" width="80"
                                                height="80">
                                        </a>
                                ...
                                <div class="product">
                                    ...
                                    <figure class="product-image-container">
                                        <a href="product.html" class="product-image">
                                            <img src="{{ config('custom.public_path') . '/frontAssets/assets/images/products/product-2.jpg'}}" alt="product" width="80"
                                                height="80">
                                        </a>
                                ...
                                <div class="product">
                                    ...
                                    <figure class="product-image-container">
                                        <a href="product.html" class="product-image">
                                            <img src="{{ config('custom.public_path') . '/frontAssets/assets/images/products/product-3.jpg'}}" alt="product" width="80"
                                                height="80">
                                        </a>
                                        <a href="#" class="btn-remove" title="Remove Product"><span>×</span></a>
                                    </figure>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 p-0">
                                    <div class="menu-banner">
                                        <figure>
                                            <img src="{{ config('custom.public_path') . '/frontAssets/assets/images/menu-banner.jpg'}}" width="192" height="313"
                                                alt="Menu banner">
                                        </figure>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 p-0">
                                    <div class="menu-banner menu-banner-2">
                                        <figure>
                                            <img src="{{ config('custom.public_path') . '/frontAssets/assets/images/menu-banner-1.jpg'}}" width="182" height="317"
