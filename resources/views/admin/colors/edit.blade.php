                            ...
                            <form action="{{ route('colors.update', $color->id) }}" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <span id="colorPreviewBadge"
                                            style="display:inline-block;width:38px;height:38px;border-radius:50%;background:{{ old('hex_code', $color->hex_code) }};border:1px solid #dee2e6;flex-shrink:0;"></span>
                                    </div>
                                    @error('hex_code')
                                ...
                                <div class="d-flex justify-content-end gap-2 mt-4">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="feather-save me-2"></i>Update Color
                                    </button>
                                </div>
                            </form>
                        </div>
