                    ...
                    <div class="card stretch stretch-full">
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table table-hover" id="subCategoryTable" data-url="{{ route('sub-categories.data') }}">
                                    <thead>
                                        <tr>
                                            <th>Srno</th>
                                            <th>Name</th>
              ...
              //  var newStatus = $(this).val();
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#sub_category').DataTable().ajax.reload(null, false); // Reload the table without resetting the pagination
                    },
