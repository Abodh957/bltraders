                            ...
                            <form action="{{ route('brands.update', $brand->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 mb-4">
                                        ...
                                        <select name="store_id" class="form-control">
                                            ...
                                            @foreach($stores as $s)
                                                <option value="{{ $s->id }}" {{ old('store_id', $brand->store_id) == $s->id ? 'selected' : '' }}>{{ $s->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-lg-4 mb-4">
                                        ...
                                        <input type="text" name="name" value="{{ old('name', $brand->name) }}" id="nameInput"
                                    ...
                                    <div class="col-lg-4 mb-4">
                                        ...
                                        <input type="text" name="slug" value="{{ old('slug', $brand->slug) }}" id="slugInput"
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mb-4">
                                        ...
                                        <div class="mt-2">
                                            <img id="logoPreview"
                                                src="{{ $brand->logo_url ? config('custom.public_path') . $brand->logo_url : '' }}"
                                                alt="Logo"
                                                style="max-width:120px;max-height:80px;object-fit:contain;border-radius:6px;border:1px solid #dee2e6;{{ $brand->logo_url ? '' : 'display:none;' }}"
                                    ...
                                    <div class="col-lg-6 mb-4">
                                        ...
                                        <div class="mt-2">
                                            <img id="coverPreview"
                                                src="{{ $brand->cover_url ? config('custom.public_path') . $brand->cover_url : '' }}"
                                                alt="Cover"
                                                style="max-width:200px;max-height:80px;object-fit:cover;border-radius:6px;border:1px solid #dee2e6;{{ $brand->cover_url ? '' : 'display:none;' }}"
                                                onerror="this.style.display='none'">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mb-4">
                                        ...
                                        <input type="text" name="meta_title" value="{{ old('meta_title', $brand->meta_title) }}"
                                    ...
                                    <div class="col-lg-12 mb-4">
                                        ...
                                        <textarea name="meta_description" rows="2" placeholder="SEO meta description"
                                            class="form-control @error('meta_description') is-invalid @enderror">{{ old('meta_description', $brand->meta_description) }}</textarea>
